...
contenedorPrincipal.className = "container-fluid";
 ...
 function recorrer(item,index){
  console.log("entro en item"+item.imagen);
        ...
        contenedorImagen1.className = "imagenx ";
          ...
          tituloImagen1.textContent = item.nombre;
        ...
        contenedorImagen1.style.backgroundImage= "url('"+item.imagen+"')";
        ...
        elTexto1.textContent =item.descripcion;
 ...
 bodyX.appendChild(contenedorPrincipal);
 console.log("body:"+bodyX);
}
